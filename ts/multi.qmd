...
# US treasury rate 10 Years, South Korea government bond rate 10Years, seoul housing index
...
fig1 <- plot_ly() %>%
  add_lines(x = as.numeric(time(tail(ts_obj[, "housing"], 100))), 
            y = as.numeric(tail(ts_obj[, "housing"], 100)), 
            name = "Historical", line = list(color = "black")) %>%
  add_lines(x = as.numeric(time(fcast$forecast$housing$mean)), 
            y = as.numeric(fcast$forecast$housing$mean), 
            name = "Forecast", line = list(color = "blue", width = 2)) %>%
  add_ribbons(x = as.numeric(time(fcast$forecast$housing$mean)), 
  ...
  add_ribbons(x = as.numeric(time(fcast$forecast$housing$mean)), 
              ...
              name = "80% CI", 
              line = list(color = "transparent")) %>%
  layout(title = "VAR(1) Forecast for housing",
         xaxis = list(title = "Year"),
         yaxis = list(title = "housing"),
         hovermode = "x unified")

fig2 <- plot_ly() %>%
  add_lines(x = as.numeric(time(tail(ts_obj[, "KR_10Y"], 100))), 
            y = as.numeric(tail(ts_obj[, "KR_10Y"], 100)), 
            name = "Historical", line = list(color = "black")) %>%
  add_lines(x = as.numeric(time(fcast$forecast$KR_10Y$mean)), 
            y = as.numeric(fcast$forecast$KR_10Y$mean), 
            name = "Forecast", line = list(color = "blue", width = 2)) %>%
  add_ribbons(x = as.numeric(time(fcast$forecast$KR_10Y$mean)), 
  ...
  add_ribbons(x = as.numeric(time(fcast$forecast$KR_10Y$mean)), 
              ...
              name = "80% CI",  
              line = list(color = "transparent")) %>%
  layout(title = "VAR(1) Forecast for KR_10Y",
         xaxis = list(title = "Year"),
         yaxis = list(title = "KR_10Y"),
         hovermode = "x unified")

fig3 <- plot_ly() %>%
  add_lines(x = as.numeric(time(tail(ts_obj[, "US_10Y"], 100))), 
            y = as.numeric(tail(ts_obj[, "US_10Y"], 100)), 
            name = "Historical", line = list(color = "black")) %>%
  add_lines(x = as.numeric(time(fcast$forecast$US_10Y$mean)), 
            y = as.numeric(fcast$forecast$US_10Y$mean), 
            name = "Forecast", line = list(color = "blue", width = 2)) %>%
  add_ribbons(x = as.numeric(time(fcast$forecast$US_10Y$mean)), 
  ...
  add_ribbons(x = as.numeric(time(fcast$forecast$US_10Y$mean)), 
              ...
              name = "80% CI", 
              line = list(color = "transparent")) %>%
  layout(title = "VAR(1) Forecast for US_10Y",
         xaxis = list(title = "Year"),
         yaxis = list(title = "US_10Y"),
         hovermode = "x unified")
